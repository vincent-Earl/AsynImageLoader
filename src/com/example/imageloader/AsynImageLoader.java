...
public class AsynImageLoader {
	 ...
	 * 	 a,下载图片时，使用线程池下载
	 */
	private static String TAG = "AsynImageLoader";
	/**
	 * 图片缓存
	 */
	...
	public void loadImage(final String imageUrl,final ImageLoadInterface callback){
		...
		executorService.submit(new Runnable() {
			...
			private void saveImageToSDCard(Drawable drawable,String imageUrl){
				...
				boolean sdcradState = Environment.getExternalStorageState().equals(android.os.Environment.MEDIA_MOUNTED);
				if(sdcradState){
